...
public partial class AdminPanel_Country_Country : System.Web.UI.Page
{
    ...
    protected void gvCountryShow_RowCommand(object sender, GridViewCommandEventArgs e)
    {
    ...
    protected void displayCountry()
    {
        ...
        try
        {
            ...
            gvCountryShow.DataSource = objSDR;
            gvCountryShow.DataBind();
