<%@ Page Title="" Language="C#" MasterPageFile="~/content/multiAdressbook.master" AutoEventWireup="true" CodeFile="CountryAddEdit.aspx.cs" Inherits="AdminPanel_Country_CountryAddEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <title>AddressBook | Country Add/Edit
    </title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div runat="server" ID="CountryEdit">
        <div class="container mt-3 divCountryEdit">
            ...
            <div runat="server" ID="FormSection" Visible="true" class="row">
                ...
                <div class="container">
                    <div class="row">
                        <hr />
                            <div class="mb-3">
                                <asp:TextBox runat="server" ID="txtCountryName" placeholder="Country Name" CssClass="form-control" />
                            </div>
                            <div class="mb-3">
                                <asp:TextBox runat="server" ID="txtCountryCode" placeholder="Country Code" CssClass="form-control" />
                            </div>
                        <div class="mb-3">
                            <asp:Label runat="server" ID="lblErrorMessage" CssClass="text-dark" Font-Bold="true" />
                        </div>
                        <div class="mb-3">
                            <asp:Button runat="server" ID="btnSubmitCountry"  CssClass="btn btn-danger" OnClick="btnSubmitCountry_Click" />
                        </div>
                        <div class="mb-3">
