...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <title>AddressBook | State Add/Edit
    </title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div runat="server" ID="StateEdit">
        <div class="container mt-3 divStateEdit">
                ...
                <div class="container">
                    <div class="row">
                        <hr />
                            ...
                            <div class="mb-3">
                                <asp:TextBox runat="server" ID="txtStateName" placeholder="State Name" CssClass="form-control" />
                            </div>
                            <div class="mb-3">
                                <asp:TextBox runat="server" ID="txtStateCode" placeholder="State Code" CssClass="form-control" />
                            </div>
                        ...
                        <div class="mb-3">
                            <asp:Button runat="server" ID="btnSubmitState" CssClass="btn btn-danger" OnClick="btnSubmitState_Click" />
                        </div>
                        <div class="mb-3">
